...
const deliveryTracking: { [orderId: number]: any[] } = {
  1: [
    {
      id: 1,
      status: 'confirmed',
...
// Helper functions
function getEstimatedDelivery(createdAt: Date, currentStatus: string): Date {
...
function calculateAverageDeliveryTime(userOrders: Order[]): number {
